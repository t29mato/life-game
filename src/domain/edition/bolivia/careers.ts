...
export const GRADUATE_CAREERS: readonly Career[] = [
  ...
  },
  {
    ...
    requiresDegree: true,
    icon: 'career:architect',
    description: 'Designs façades in greens and golds the old school calls impossible and the whole high city now takes for granted. Your buildings are visible from the cable car, which is the point.',
  },
  {
