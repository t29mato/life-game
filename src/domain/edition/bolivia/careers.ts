...
export const BASIC_CAREERS: readonly Career[] = [
  ...
  },
  {
    ...
    description: 'Seals a pastry that holds a spoonful of soup against all known physics, and eats standing up like everyone who knows how.',
  ...
  },
  {
    ...
    description: 'Lays the red brick half the city is built from, plumb by eye, and leaves the roof rebar standing — every house here plans to grow another floor.',
  ...
  },
  {
    ...
    requiresDegree: false,
    icon: 'space:family-portrait',
    description: 'August is booked two years out and Lent is silence — the fiesta calendar is the wheel, and the sponsors decide the year.',
  },
  // --- the import trade ----------------------------------------------------
  {
    ...
    description: 'Sells electronics from a stall two metres wide, knows the landed price of everything in it to the centavo, and undercuts the shops by knowing it.',
  ...
  // --- the pet salon -------------------------------------------------------
  {
    ...
    description: 'Towels, treats, and the nerve to hold still while a very small dog in a very warm knitted jumper decides about you.',
...
export const GRADUATE_CAREERS: readonly Career[] = [
  ...
  },
  {
    ...
    requiresDegree: true,
    icon: 'career:surgeon',
    description: 'Operates at an altitude most textbooks footnote, with steady hands and a physiology chapter the rest of the world flies in to study.',
  },
  {
  ...
  },
  {
    ...
    requiresDegree: true,
    icon: 'career:architect',
    description: 'Designs façades in greens and golds the old school calls impossible and the whole high city calls Tuesday. Your buildings are visible from the cable car, which is the point.',
  },
  {
  ...
  },
  {
    ...
    description: 'Logs cores on a salt flat so vast and so white that the horizon gives up, and considers it the best office in the hemisphere.',
  ...
  },
  {
    ...
    requiresDegree: true,
    icon: 'career:architect',
    description: 'Checks culvert drawings for a mountain highway, and learns that in these mountains the drawing is a suggestion the rock reviews.',
