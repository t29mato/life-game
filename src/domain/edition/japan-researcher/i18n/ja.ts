...
export const RESEARCHER_JAPAN_JA: EditionTranslation = {
  ...
  spaces: {
    ...
    'jpr-doc-first-post': {
      title: '最初のポスト',
      description: '全国の公募が並んでいる。どれにも着任日と任期の終わりと、すでに決まった研究テーマがついている。二つが採ってくれる。どちらかを選ぶ。',
    },
    ...
    'jpr-corridor-first-review': {
      title: '最初の面談',
      description: '入って半年、三枚複写の用紙を持った人が向かいに座り、調子はどうかと尋ねる。振ろう。',
      reason: '最初の半年が終わった',
    },
    'jpr-corridor-bank': {
      title: '銀行の窓口',
    ...
    'jpr-bench-renewal': {
      title: '更新',
      description: 'この研究室はここ十年、誰も出ていない。上のポストは誰かが定年を迎えて初めて空く。今年がその年かどうか、振ってみよう。',
      reason: '上のポストが空いた',
    },
    'jpr-leave-lookout': {
      title: 'こっそり応募する',
    ...
    'jpr-corridor-review': {
      title: '審査',
      description: '小さな部屋、こちらの資料を挟んで座る二人、そして質問はひとつ。上のポストを任せて大丈夫か。振って、返事を聞こう。',
      reason: '審査の順番が回ってきた',
    },
    'jpr-corridor-tax': {
      title: '税務調査',
    ...
    'jpr-ladder-open-call': {
      title: '公募',
      description: '一件の公募が全国に出る。三十一人が出し、四人が面接に呼ばれ、一人が決まり、関わる全員がどこかの学会で顔を合わせている。振ろう。',
      reason: '公募が出た',
    },
    'jpr-ladder-cliff': {
      title: '十年ルール',
      description: '十年目。数えていた人間は、十年目が何を意味するか知っている。届いた文書には、終わりの日付がどこにもない。二つの部局が来てほしいと言っている。どちらかを選ぶ。',
    ...
    'jpr-after-fair': {
      title: '転職フェア',
      description: '何ひとつ間違えなかったのに、ポストのほうが尽きた人たちのためのブースが並ぶ。ここで業績リストを読む人はいない。二社が二枚の職務経歴書を気に入る。どちらかを選ぶ。',
      reason: '入口の等級で仕切り直し',
    },
    'jpr-wedding': {
      title: '結婚式',
    ...
    'jpr-family-new-baby': {
      title: '赤ちゃんが来た',
      description: '小さな同居人が増える。申請の〆切の三週間前で、その〆切は思っていたよりずっとどうでもいいことがわかる。',
    },
    'jpr-family-waitlist': {
      title: '保育園の待機',
    ...
    'jpr-grant-payday': {
      title: '給料日',
      description: '頭金の期日と同じ週に、振り込みが届く。',
    },
    ...
    'jpr-spinout-seed': {
      title: 'シードの調達',
      description: '自分の特許でできた会社に貯金を入れ、書類十一枚に判を押し、調達がどうなったかを振って確かめる。',
      reason: 'シードの調達',
    },
    'jpr-spinout-bad-tip': {
      title: '勧めてしまった',
    ...
    'jpr-spinout-acquisition-talk': {
      title: '買収の打診',
      description: 'たいへん大きな会社が二年前からこちらの特許を読んでいて、一度話したいと言ってくる。その話がいくらになったか、振ろう。',
      reason: '買収の話',
    },
    'jpr-spinout-payday': {
      title: '給料日',
    ...
    'jpr-emeritus-named-chair': {
      title: '最後の教授会',
      description: '扉を出る前にもう一つだけ肩書きを、教授会が頷いてくれるなら。振って、研究者人生で最後の審査に決めてもらおう。',
      reason: '人生で最後の審査',
    },
