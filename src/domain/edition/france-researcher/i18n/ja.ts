...
export const RESEARCHER_FRANCE_JA: EditionTranslation = {
  ...
  spaces: {
    ...
    'frr-ge-recruitment-forum': {
      title: '学校の就職フォーラム',
      description: '最終学年の十一月、学校の講堂に二百社。九月に始まる契約と、学年じゅうがもう知っている初任給を手に帰る。',
    },
    'frr-ge-first-pay': {
      title: '初めての給与明細',
      description: '四ページ、社会保険料が十一行、そして一番下の数字は、二十三歳のとき家族の誰が稼いだ額より多い。その金で親を食事に連れていく。',
      reason: '初任給',
      footnote: 'ひと月まるごとではなく、その途中から働き始めた分。まるひと月分が入るのは次の「給料日」のマス。',
    },
    'frr-ge-payday-1': {
      title: '給料日',
      description: 'まるひと月働いた。昔の同級生がまだ分光器と言い争っているうちに、振り込みが届く。',
      harsher: {
        title: '給料は翌月払い',
        description: '初月の給料が一か月遅れで払われるとは誰も言わなかったし、部屋の敷金を預かる業者は待ってくれなかった。',
        reason: '無収入のひと月',
      },
    },
    'frr-ge-deposit': {
      title: '敷金と保証人',
      description: '二か月ぶんの前払い、博士論文より分厚い審査書類、そして大家は、フランス在住で家賃の三倍を稼ぐ保証人も欲しがる。',
      reason: '敷金と前家賃',
    },
    'frr-ge-first-night': {
      title: '最初の夜',
      description: '段ボール四箱を開ける。うち三箱は本だ。テーブルは木曜に届くので、立ったまま食べる。',
    },
    'frr-ge-school-invoice': {
      title: '学校からの最後の請求',
      description: '給料が出るまで待ってくれていた最終学年の学費が、給料が出た月に届く。学校はこちらをたいへん誇りに思っていて、そして払ってほしい。',
      reason: '最終学年の学費',
    },
    'frr-ge-payday-2': {
      title: '給料日',
      description: 'ひと月働いてまた振り込み。博士論文なら何を書くはずだったかは、誰にも一度も聞かれない。',
      harsher: {
        title: '賞与の査定し直し',
        description: '事業部が数字を落とし、給料の変動部分は、この建物に来たこともない誰かに査定し直される。',
        reason: '半分になった賞与',
      },
    },
    'frr-ge-payday-3': {
      title: '給料日',
      description: '明細三枚目。口座の残高が習慣らしい顔をしはじめた。高校の物理の先生が心から喜んでくれて、そのことを長々と言う。',
    },
  ...
  lanes: {
    'The University': {
      name: '大学に残る',
      summary: '修士と博士論文にもう五年。金が出るかどうかは、夏に委員会が決める。六年に一度は、企業に雇われ、給料をもらいながら書く博士課程に当たる。終えれば博士だ。この国では、たった一つの扉の前ですべての値打ちがあり、ほかのほとんどの扉の前では何の値打ちもない。',
    },
    'The Grande École': {
      name: 'グランゼコール',
      summary: '二年の受験準備課程、入学試験ひとつ、そして名前が四十年ぶん扉を開け続ける学校で三年。契約は卒業より先に、学校の就職フォーラムで決まる。初月から本物の給料が入り、この道の人間は、博士課程をやるかどうかで一晩も悩まない。',
    },
    'Stay Where You Are': {
      name: '動かない',
