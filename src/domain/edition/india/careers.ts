 ...
 * photographer's season — and `salary` is exactly `payPerPip × 5.5` so the
...
export const BASIC_CAREERS: readonly Career[] = [
  ...
  // --- the sweet shop ------------------------------------------------------
  {
    ...
    requiresDegree: false,
    icon: 'space:new-skills',
    description: 'In at four, out at ten, and not yet allowed near the syrup. The milk, you are told, is the entire job.',
  ...
  },
  {
    ...
    description: 'Stands the vats, reads the sugar, and knows by the smell of the ghee exactly when to look away from a conversation.',
...
export const GRADUATE_CAREERS: readonly Career[] = [
  ...
  },
  {
    ...
    description: 'Gave three years of your twenties to one examination, cleared it on the attempt you had promised would be the last, and now the district is the syllabus.',
  ...
  },
  {
    ...
    requiresDegree: true,
    icon: 'tile:novel',
    description: 'Serialised at last. The pay is a wheel, the Thursday ratings are a guillotine, and the wedding episode is annual forever.',
  },
  // --- callings ------------------------------------------------------------
  {
